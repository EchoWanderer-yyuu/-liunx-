...
{
    int socketfd,clientfd,temp_result;
    ...
    //返回的文件描述符才是能够喝客户端收发消息的文件描述符
    //如果调用accept之后没有客户端，这里会挂起等待
    clientfd=accept(socketfd,(struct sockaddr *)&clientfd,&clientaddr_len);
